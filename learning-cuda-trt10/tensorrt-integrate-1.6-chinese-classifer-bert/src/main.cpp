...
static vector<int64_t> _classes_colors = {
...
void inference(const char *input_text)
{
    ...
    ///////////////////////////////////////////////////
    // letter box
    const char *input = input_text; //"2岁男童爬窗台不慎7楼坠下获救(图)";
    ...
    int64_t num_classes = output_dims.d[1];
    int64_t output_numel = input_batch * num_classes;
    ...
    int64_t predict_label = std::max_element(output_data_host, output_data_host + num_classes) - output_data_host;
