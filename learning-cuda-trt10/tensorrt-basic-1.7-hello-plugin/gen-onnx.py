...
torch.onnx.export(
    ...
    # 对于插件，需要禁用onnx检查
    verify=False,
    # index error, set following option to False, https://github.com/pytorch/pytorch/issues/119981
    autograd_inlining=False
)

# torch.onnx.export(..., dynamo=True) is the newest (still in beta) exporter
# using torch.export and Torch FX to capture the graph. It was released with PyTorch 2.5
# see this for details: https://pytorch.org/tutorials/beginner/onnx/export_simple_model_to_onnx_tutorial.html
