...
private:
    ...
    void refitOnnxWeights(::onnx::ModelProto const& onnx_model);
    void refitOnnxGraph(::onnx::GraphProto const& graph);
    void refitOnnxNode(::onnx::NodeProto const& node, ::onnx::GraphProto const& graph);
    void refitOnnxConstantNode(::onnx::NodeProto const& node, std::string const& graphName);
    void refitOnnxBatchNormNode(::onnx::NodeProto const& node, ::onnx::GraphProto const& graph);
    void refitOnnxIfNode(::onnx::NodeProto const& node);
    void refitOnnxLoopNode(::onnx::NodeProto const& node);
    void refitOnnxScanNode(::onnx::NodeProto const& node);
