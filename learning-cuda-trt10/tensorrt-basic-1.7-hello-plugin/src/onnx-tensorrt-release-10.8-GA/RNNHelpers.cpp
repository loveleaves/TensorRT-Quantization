...
nvinfer1::ITensor* addRNNInput(ImporterContext* ctx, const ::onnx::NodeProto& node, nvinfer1::ILoop* loop,
...
nvinfer1::ITensor* clearMissingSequenceElements(ImporterContext* ctx, const ::onnx::NodeProto& node,
...
nvinfer1::ITensor* maskRNNHidden(ImporterContext* ctx, const ::onnx::NodeProto& node, nvinfer1::ILoop* loop,
...
nvinfer1::ITensor* maskBidirRNNHidden(ImporterContext* ctx, const ::onnx::NodeProto& node,
...
nvinfer1::ITensor* getRaggedMask(ImporterContext* ctx, const ::onnx::NodeProto& node, nvinfer1::ILoop* loop,
