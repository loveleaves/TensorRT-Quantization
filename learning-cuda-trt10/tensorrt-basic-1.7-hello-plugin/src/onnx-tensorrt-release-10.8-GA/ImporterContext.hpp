...
class ImporterContext
{
    ...
    StringMap<::onnx::FunctionProto> mLocalFunctions;
    ...
    struct LocalFunctionMetadata
    {
        ...
        std::string nodeName;
        StringMap<::onnx::AttributeProto const*> attrs;
    };
    ...
    std::vector<::onnx::ValueInfoProto> mGraphOutputNames;
...
public:
    ...
    void registerLayer(nvinfer1::ILayer* layer, std::string const& basename, ::onnx::NodeProto const* node);
    void registerLayer(nvinfer1::ILayer* layer, ::onnx::NodeProto const& node);
    ...
    StringMap<::onnx::FunctionProto>& localFunctions()
    {
    ...
    std::vector<::onnx::ValueInfoProto>& getGraphOutputNames()
    {
...
typedef std::function<NodeOutputs(ImporterContext* ctx, ::onnx::NodeProto const& node, size_t const nodeIdx,
