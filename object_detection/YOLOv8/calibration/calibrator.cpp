...
Int8Calibrator::Int8Calibrator(int batchsize, int input_w, int input_h, const char *img_dir, const char *calib_table_name,
    ...
    : batchsize_(batchsize), input_w_(input_w), input_h_(input_h), img_idx_(0), img_dir_(img_dir), calib_table_name_(calib_table_name), input_blob_name_(input_blob_name), read_cache_(read_cache)
{
